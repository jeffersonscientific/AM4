...
# NETCDF_FLAGS
# NETCDF_LIBS
#NETCDF_FLAGS=-I/opt/ohpc/pub/libs/intel/impi/netcdf/4.7.1/include -I/opt/ohpc/pub/libs/intel/impi/hdf5/1.10.5/include -I/opt/ohpc/pub/libs/intel/impi/netcdf-fortran/4.5.2/include
#NETCDF_LIBS=-L/opt/ohpc/pub/libs/intel/impi/netcdf-fortran/4.5.2/lib -lnetcdff -L/opt/ohpc/pub/libs/intel/impi/hdf5/1.10.5/lib -L/opt/ohpc/pub/libs/intel/impi/netcdf/4.7.1/lib -lnetcdf -lnetcdf -lm

NETCDF_FLAGS=-I${NETCDF_INC} -I${HDF5_INC} -I${NETCDF_FORTRAN_INC}
NETCDF_LIBS=-L${NETCDF_FORTRAN_LIB} -L${NETCDF_LIB} -L${MPI_DIR}/lib -L${HDF5_LIB}  -lnetcdf  -lnetcdff -lm
...
#
# MPI library.
# I assume this is somnething like -l${MPI_LIBRARY_NAME} ??
